...
function Header() {
	...
	const handleRegister = () => {
		fetch('https://morning-news-back-five.vercel.app/users/signup', {
			method: 'POST',
	...
	const handleConnection = () => {
		...
		fetch('https://morning-news-back-five.vercel.app/users/signin', {
			method: 'POST',
			headers: { 'Content-Type': 'application/json' },
	...
	if (user.token) {
		userSection = (
			<div className={styles.logoutSection}>
				<FontAwesomeIcon onClick={() => handleRemoveHidden()} className={styles.userSection} icon={faEye} />
